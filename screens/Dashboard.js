...
const expiringSoon = pantryItems.filter(item => {
  ...
  // Ensure expDate is valid
  if (isNaN(expDate.getTime())) {
    console.warn('Invalid expiration date:', item.expiration_date);
    return false;
  }
...
const styles = StyleSheet.create({
  ...
  statCards: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
  statCard: { flex: 1, backgroundColor: COLORS.white, borderRadius: 12, padding: 16, marginHorizontal: 5, alignItems: 'center' },
  ...
  quickAction: { width: '47%', backgroundColor: COLORS.white, padding: 16, borderRadius: 12, alignItems: 'center', marginBottom: 12 },
  ...
  discardedRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
  discardedStatCard: { flex: 1, borderRadius: 12, padding: 16, marginHorizontal: 5, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 2 },
